    ...
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5">
      <div className="flex items-center gap-2 mb-4">
        ...
        {mounted && currentPhase && (
          <span className="ml-1 text-[10px] font-mono uppercase tracking-wider px-2 py-0.5 rounded-full"
            style={{ color: currentPhase.slot.color, background: currentPhase.slot.color + '15' }}>
            ahora · {currentPhase.slot.label}
          </span>
        )}
        <button
  ...
  return (
    <div className="bg-zinc-950/60 border border-zinc-700 rounded-xl p-3 space-y-3">
      ...
      <div className="flex gap-2 pt-1">
        <button
          onClick={onCancel}
          className="flex-1 px-3 py-1.5 rounded-lg bg-zinc-800 hover:bg-zinc-700 text-zinc-300 text-xs font-semibold transition-colors"
        >
          Cancelar
        </button>
        <button
