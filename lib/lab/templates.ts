...
const CREENCIAS_EXERCISES: LabExercise[] = [
  {
    key: 'reencuadre-simple',
    categoryKey: 'creencias',
    emoji: '🔓',
    title: 'Reencuadre Cognitivo · SIMPLE',
    shortDescription: 'Cuando la creencia NO es verdad. Identificarla, cuestionarla y reencuadrar.',
    intro: 'Para cuando la respuesta a "¿es cierto esto?" es claramente NO. Las creencias parecen fuertes, pero son débiles — apenas las tocamos, caen como patitas de arena.',
    fields: [
      { key: 'creencia', label: 'Paso 1 · Identificá la creencia', type: 'textarea', hint: 'Una sola creencia, en frase corta. No mezcles varias.' },
    ],
    steps: [
      {
        key: 'cuestionar',
        emoji: '❓',
        title: 'Paso 2 · Cuestionar la creencia',
        intro: 'Lo mejor es reírse, no creérselo. Dejar de comprarlo.',
        fields: [
          { key: 'es_verdad', label: '¿Es esto verdad?', type: 'textarea' },
          { key: 'certeza_absoluta', label: '¿Podés decir con CERTEZA ABSOLUTA que es verdad?', type: 'textarea' },
          { key: 'por_que_no', label: '¿Por qué NO es verdad? Cuestionala, cuestionala, cuestionala.', type: 'textarea', hint: 'Lentes nuevos. Detrás de estas creencias super fuertes hay un potencial GIGANTE.' },
        ],
      },
      {
        key: 'reaccion',
        emoji: '🌊',
        title: 'Paso 3 · Cómo reaccionás al creerla',
        fields: [
          { key: 'como_reacciono', label: '¿Cómo reaccionás al saber que ese pensamiento es verdad?', type: 'textarea', hint: 'Tus pensamientos producen emociones, y desde ellas accionás.' },
          { key: 'de_que_te_aleja', label: '¿De qué te aleja pensar / sentir que es verdad?', type: 'textarea' },
        ],
      },
      {
        key: 'inversion',
        emoji: '🔄',
        title: 'Paso 4 · La inversión',
        intro: 'ADMITO que me encanta y me fascina creer en ese pensamiento. Me es cómodo pensar así. Me mantiene protegido bajo una capa que no quiero salir — pero los resultados están afuera de ese pensamiento.',
        fields: [
          { key: 'admito', label: 'Admití: "Me encanta pensar en X porque..."', type: 'textarea', hint: 'No es ironía. Es reconocimiento honesto del beneficio secundario.' },
          { key: 'quien_serias', label: '¿Quién serías sin ese pensamiento? ¿Si no actuaras desde él?', type: 'textarea' },
        ],
      },
      {
        key: 'dolor',
        emoji: '⚠️',
        title: 'Paso 5 · Asociar dolor a sostenerla',
        fields: [
          { key: 'dolor_si_sigo', label: 'Si sigo creyendo esto, ¿qué consecuencias dolorosas me esperan?', type: 'textarea', hint: 'Hacelo visceral. Lo que sentís en la garganta cuando lo imaginás.' },
        ],
      },
      {
        key: 'instalar',
        emoji: '🌱',
        title: 'Paso 6 · Instalar la creencia nueva (como acción, no como afirmación)',
        intro: 'En vez de "soy salud" → "elijo siempre el entrenamiento". En vez de "es fácil fondearme" → "es fácil para mí encontrar estrategias ganadoras y seguir mi plan".',
        fields: [
          { key: 'creencia_nueva', label: 'La creencia nueva, escrita como ACCIÓN', type: 'textarea' },
          { key: 'por_que_facil', label: 'Validala con preguntas: "¿Por qué es tan fácil para mí…?"', type: 'textarea', hint: 'Hack: en vez de "soy millonario", "¿por qué es fácil para mí tener ideas que traen millones?".' },
        ],
      },
    ],
    outro: 'CUANDO LO VEO Y LO ESCUCHO AL PENSAMIENTO, DEJO DE SER ESO. Soy el observador. El cambio es rápido si así lo creés posible. Energía e intensidad.',
  },

  {
    ...
    categoryKey: 'creencias',
    emoji: '🔍',
    title: 'Reencuadre Cognitivo · COMPLEJO',
    shortDescription: 'Cuando la creencia es parcialmente verdad. Reconocer primero, transformar después.',
    intro: 'Para cuando la pregunta "¿es cierto?" da SÍ. NO PUEDO TRANSFORMAR ALGO QUE NO RECONOZCO. A veces necesitamos admitir que SÍ pensamos eso antes de poder reencuadrar.',
    fields: [
...

  {
    ...
    categoryKey: 'creencias',
    emoji: '📜',
    title: 'Lista de Creencias a Confrontar',
    shortDescription: 'Tu catálogo personal de creencias detectadas. Vas marcando cuáles ya trabajaste.',
    intro: 'Para volcar las creencias que vas detectando en el día. Después podés crear sesiones de Reencuadre (Simple o Complejo) tomando una de acá.',
    fields: [
      { key: 'lista', label: 'Creencias detectadas (una por línea)', type: 'textarea', placeholder: '- Es difícil hacer dinero\n- No soy capaz de sostener resultados\n- Si no gano todo estuvo mal\n- ...', hint: 'Ordená por intensidad. Las más resistidas suelen tener más potencial detrás.' },
      { key: 'trabajadas', label: 'Creencias YA trabajadas (con qué insight te quedaste)', type: 'textarea' },
    ],
    outro: 'A medida que las trabajás, pasalas a "trabajadas" con una línea del insight clave. Es tu mapa.',
  },
]
